...
public class XML {
    ...
    public static ArrayList<HumanBeing> XMLToHuman(String[] xmlForm){
        ...
        for(String xmlString:xmlForm){
            ...
            humanBeings.add(new HumanBeing(id,name,new Coordinates(x,y),realHero,hasToothpick,impactSpeed,soundtrackName,minutesOfWaiting,weaponType,new Car(carName)));
